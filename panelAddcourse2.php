        ...
        <body>
            <?php include_once 'sideBar.php'; ?>
              ...
              <div id="fourth_page" style="margin-left: 20%;">
                <ul class="top_nav3">
                  <li class="note1">Students > year 2</li>
...
<span class="labels">Level</span>  <select id="level" name="school">
       ...
       <option value="500">500</option>
              ...
              <option value="chm201">CHM 201</option>
              <option value="chm203">CHM 203</option>
              <option value="chm206">CHM 206</option>
              <option value="chm208">CHM 208</option>
              <option value="chm222">CHM 222</option>
              <option value="csc201">CSC 201</option>
              <option value="ecn201">ECN 201</option>
              <option value="ecn204">ECN 204</option>
              <option value="eng201">ENG 201</option>
              <option value="eng203">ENG 203</option>
              <option value="gst201">GST 201</option>
              <option value="imt201">IMT 201</option>
              <option value="mgt202">MGT 202</option>
              <option value="mgt204">MGT 204</option>
              <option value="mgt206">MGT 206</option>
              <option value="mth201">MTH 201</option>
              <option value="sta211">STA 211</option>
