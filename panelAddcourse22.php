...
<span class="labels">Level</span>  <select id="level" name="school">
       ...
       <option value="500">500</option>
              ...
              <option value="chm202">CHM 202</option>
              <option value="chm204">CHM 204</option>
              ...
              <option value="ecn202">ECN 202</option>
              <option value="ecn204">ECN 204</option>
              <option value="eng203">ENG 203</option>
              <option value="imt202">IMT 202</option>
              <option value="mth202">MTH 202</option>
              <option value="sta222">STA 222</option>
                     </select>
                   </div>
              </div>
