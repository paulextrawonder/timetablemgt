        ...
        <body>
           <?php include_once 'sideBar.php'; ?>
              ...
              <div id="fourth_page" style="margin-left: 20%;">
                <ul class="top_nav3">
                  <li class="note1">Students > year 4</li>
...
<span class="labels">Level</span>  <select id="level" name="school">
       ...
       <option value="500">500</option>
              ...
              <span style="margin-left: 4%;" class="labels">Course Code</span> <select id="coursecode" name="school">
               <option value="imt405">IMT 405</option>
              <option value="imt407">IMT 407</option>
              <option value="imt409">IMT 409</option>
              <option value="imt411">IMT 411</option>
              <option value="imt401">IMT 401</option>
              <option value="imt403">IMT 403</option>
              <option value="mgt406">MGT 406</option>
              <option value="mgt403">MGT 403</option>
                     </select>
                   </div>
              </div>
