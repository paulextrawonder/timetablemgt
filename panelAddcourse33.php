...
<span class="labels">Level</span>  <select id="level" name="school">
       ...
       <option value="500">500</option>
              ...
              <option value="imt314">IMT 314</option>
              <option value="imt308">IMT 308</option>
              <option value="imt306">IMT 306</option>
              <option value="imt310">IMT 310</option>
              <option value="imt318">IMT 318</option>
              <option value="mgt316">MGT 316</option>
              <option value="mgt304">MGT 304</option>
              <option value="ens302">ENS 302</option>
                     </select>
                   </div>
              </div>
