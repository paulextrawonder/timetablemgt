...
<span class="labels">Level</span>  <select id="level" name="school">
       ...
       <option value="500">500</option>
              ...
              <option value="imt305">IMT 305</option>
              <option value="imt307">IMT 307</option>
              <option value="imt309">IMT 309</option>
              <option value="1mt303">IMT 303</option>
              <option value="imt313">IMT 313</option>
              <option value="mgt303">MGT 303</option>
              <option value="ens301">ENS 301</option>
