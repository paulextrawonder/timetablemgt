        ...
        <body>
            <?php include_once 'sideBar.php'; ?>
              ...
              <div id="fourth_page" style="margin-left: 20%;">
                <ul class="top_nav3">
                  <li class="note1">Students > year 1</li>
   ...
   <span class="labels">School</span>  <select id="school" name="school">
    ...
    <span class="labels">Level</span>  <select id="level" name="school">
           ...
           <option value="500">500</option>
              ...
              <option value="BIO103">BIO 103</option>
              <option value="CHM102">CHM 102</option>
              <option value="ENG102">ENG 102</option>
              <option value="ENG104">ENG 104</option>
              <option value="FRN102">FRN 102</option>
              <option value="GST102">GST 102</option>
              <option value="GST110">GST 110</option>
              <option value="GST108">GST 108</option>
              <option value="IGB102">IGB 102</option>
              <option value="MTH102">MTH 102</option>
